        ...
        <div className='CardsDiscription'>
            ...
            <div className="otherDisc ">
                ...
                <h4 className="font-semibold md:text-sm text-xs" >{distance} mins away</h4>
                    ...
                    <button className="  w-full font-bold bg-lime-300 px-4 mt-2 text-sm rounded-xl md:text-lg  " onClick={() => eventHandler({...restaurant})} > remove </button>
                    </div>
